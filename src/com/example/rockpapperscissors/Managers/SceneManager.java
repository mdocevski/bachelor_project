...
import com.example.rockpapperscissors.Scenes.GameLevel;
import com.example.rockpapperscissors.Scenes.MainMenu;
import com.example.rockpapperscissors.Scenes.ManagedLayer;
import com.example.rockpapperscissors.Scenes.ManagedScene;
import com.example.rockpapperscissors.Scenes.NewUnitLayer;
import com.example.rockpapperscissors.Scenes.EndGameLayer;
import com.example.rockpapperscissors.Scenes.OptionsLayer;
import com.example.rockpapperscissors.Scenes.TutorialLayer;
...
public class SceneManager extends Object {
	...
	// Active GameLevel varialbe used for communication between New Unit Layer
	// and the game level
	private GameLevel activeGameLevel = null;

	public GameLevel getActiveGameLevel() {
		return activeGameLevel;
	}

	public void setActiveGameLevel(GameLevel pActiveGameLevel) {
		activeGameLevel = pActiveGameLevel;
	}

	public void clearActiveGameLevel() {
	...
	public void showNewUnitLayer(final boolean pSuspendCurrentSceneUpdates) {
		showLayer(NewUnitLayer.getInstance(), false,
				pSuspendCurrentSceneUpdates, true);
	}

	public void showEndGameLayer(final boolean pSuspendCurrentSceneUpdates) {
		showLayer(EndGameLayer.getInstance(), false,
				pSuspendCurrentSceneUpdates, true);
	}

	public void showTutorialLayer(final boolean pSuspendCurrentSceneUpdates) {
		showLayer(TutorialLayer.getInstance(), false,
				pSuspendCurrentSceneUpdates, true);
	}
